...
export function Popup({open, setOpen, title, description, onAccept, onDecline, acceptText, inputText}: PopupProps) {
							 ...
							 <Dialog.Panel
								 ...
								 <div>
									 <div className="mt-3 text-center sm:mt-5">
										 ...
										 <br/>
										 <Dialog.Title as="p" className="text-base font-semibold leading-6 text-gray-900">
											 {description}
										 </Dialog.Title>
										 <input
												type="text"
